...
CREATE TABLE `sys_acl`  (
  ...
  `operate_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '最后一次更新时间',
...
CREATE TABLE `sys_log`  (
  ...
  `operator` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '最后一次更新的时间',
...
INSERT INTO `sys_log` VALUES (26, 6, 5, '[]', '[7,8,9,10]', 'Admin', '2020-03-22 20:20:00', '127.0.0.1', 1);
INSERT INTO `sys_log` VALUES (27, 7, 5, '[]', '[5]', 'Admin', '2020-03-22 20:20:12', '127.0.0.1', 1);
...
INSERT INTO `sys_role_acl` VALUES (17, 5, 7, 'Admin', '2020-03-22 20:20:00', '127.0.0.1');
INSERT INTO `sys_role_acl` VALUES (18, 5, 8, 'Admin', '2020-03-22 20:20:00', '127.0.0.1');
INSERT INTO `sys_role_acl` VALUES (19, 5, 9, 'Admin', '2020-03-22 20:20:00', '127.0.0.1');
INSERT INTO `sys_role_acl` VALUES (20, 5, 10, 'Admin', '2020-03-22 20:20:00', '127.0.0.1');
...
INSERT INTO `sys_role_user` VALUES (18, 5, 5, 'Admin', '2020-03-22 20:20:10', '127.0.0.1');
