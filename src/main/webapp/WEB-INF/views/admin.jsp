<%@ page import="com.taoyuan.common.RequestHolder" %>
<%@ page import="com.taoyuan.model.SysUser" %>
    ...
    <div class="navbar-container">
        ...
        <div class="navbar-buttons navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                <li class="myopen light-blue dropdown-modal">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".popstyle").each(function () {
            var $this = $(this);
            tmp = $this.attr("href");//url
            $this.attr("data", tmp);//data=url并添加在popstyle上
            //添加上href:javascript:void(0)
